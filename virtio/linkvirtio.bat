...
mklink virtio_net\virtio_pci_legacy.c %start_dir%\virtio_base\virtio_pci_legacy.c
if exist virtio_net\virtio_pci_modern.c del virtio_net\virtio_pci_modern.c
mklink virtio_net\virtio_pci_modern.c %start_dir%\virtio_base\virtio_pci_modern.c
if exist virtio_net\virtio_utils.c del virtio_net\virtio_utils.c
mklink virtio_net\virtio_utils.c %start_dir%\virtio_base\virtio_utils.c
...
mklink virtio_scsi\virtio_pci_legacy.c %start_dir%\virtio_base\virtio_pci_legacy.c
if exist virtio_scsi\virtio_pci_modern.c del virtio_scsi\virtio_pci_modern.c
mklink virtio_scsi\virtio_pci_modern.c %start_dir%\virtio_base\virtio_pci_modern.c
if exist virtio_scsi\virtio_utils.c del virtio_scsi\virtio_utils.c
mklink virtio_scsi\virtio_utils.c %start_dir%\virtio_base\virtio_utils.c
if exist virtio_scsi\storport_reg.c del virtio_scsi\storport_reg.c
mklink virtio_scsi\storport_reg.c %root_dir%\virtio\virtio_blk\storport_reg.c
if exist virtio_scsi\virtio_sp_common.c del virtio_scsi\virtio_sp_common.c
mklink virtio_scsi\virtio_sp_common.c %root_dir%\virtio\virtio_sp_common\virtio_sp_common.c
...
mklink virtio_blk\virtio_pci_legacy.c %start_dir%\virtio_base\virtio_pci_legacy.c
if exist virtio_blk\virtio_pci_modern.c del virtio_blk\virtio_pci_modern.c
mklink virtio_blk\virtio_pci_modern.c %start_dir%\virtio_base\virtio_pci_modern.c
if exist virtio_blk\virtio_utils.c del virtio_blk\virtio_utils.c
mklink virtio_blk\virtio_utils.c %start_dir%\virtio_base\virtio_utils.c
if exist virtio_blk\virtio_sp_common.c del virtio_blk\virtio_sp_common.c
mklink virtio_blk\virtio_sp_common.c %root_dir%\virtio\virtio_sp_common\virtio_sp_common.c
...
mklink virtio_balloon\virtio_pci_legacy.c %start_dir%\virtio_base\virtio_pci_legacy.c
if exist virtio_balloon\virtio_pci_modern.c del virtio_balloon\virtio_pci_modern.c
mklink virtio_balloon\virtio_pci_modern.c %start_dir%\virtio_base\virtio_pci_modern.c
if exist virtio_balloon\virtio_pci_wdm.c del virtio_balloon\virtio_pci_wdm.c
mklink virtio_balloon\virtio_pci_wdm.c %start_dir%\virtio_base\virtio_pci_wdm.c
if exist virtio_balloon\virtio_utils.c del virtio_balloon\virtio_utils.c
mklink virtio_balloon\virtio_utils.c %start_dir%\virtio_base\virtio_utils.c
...
mklink virtio_serial\virtio_pci_legacy.c %start_dir%\virtio_base\virtio_pci_legacy.c
if exist virtio_serial\virtio_pci_modern.c del virtio_serial\virtio_pci_modern.c
mklink virtio_serial\virtio_pci_modern.c %start_dir%\virtio_base\virtio_pci_modern.c
if exist virtio_serial\virtio_pci_wdm.c del virtio_serial\virtio_pci_wdm.c
mklink virtio_serial\virtio_pci_wdm.c %start_dir%\virtio_base\virtio_pci_wdm.c
if exist virtio_serial\virtio_utils.c del virtio_serial\virtio_utils.c
mklink virtio_serial\virtio_utils.c %start_dir%\virtio_base\virtio_utils.c
...
mklink virtio_rng\virtio_pci_legacy.c %start_dir%\virtio_base\virtio_pci_legacy.c
if exist virtio_rng\virtio_pci_modern.c del virtio_rng\virtio_pci_modern.c
mklink virtio_rng\virtio_pci_modern.c %start_dir%\virtio_base\virtio_pci_modern.c
if exist virtio_rng\virtio_pci_wdm.c del virtio_rng\virtio_pci_wdm.c
mklink virtio_rng\virtio_pci_wdm.c %start_dir%\virtio_base\virtio_pci_wdm.c
if exist virtio_rng\virtio_utils.c del virtio_rng\virtio_utils.c
mklink virtio_rng\virtio_utils.c %start_dir%\virtio_base\virtio_utils.c

if exist pvcrash_notify\virtio_utils.c del pvcrash_notify\virtio_utils.c
mklink pvcrash_notify\virtio_utils.c %start_dir%\virtio_base\virtio_utils.c

if exist fwcfg\virtio_utils.c del fwcfg\virtio_utils.c
mklink fwcfg\virtio_utils.c %start_dir%\virtio_base\virtio_utils.c
